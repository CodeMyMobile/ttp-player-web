...
export function ScoreCell({ value, max, onChange, tone, state }) {
...
export function ResultPill({ me, opponent, result, dnf }) {
...
function Board({ me, opponent, sets, format, result, controls }) {
...
export function ReadBoard(props) {
...
export function ScoreSection({ me, opponent, format, sets, dnf, dnfWinner, result, controls }) {
  return (
    <div>
